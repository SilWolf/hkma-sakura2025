...
export default async function TeamDetail({
  ...
  const slug = (await params).slug;
  const foundTeam = await getRegularTeamsWithPlayers().then((teams) =>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-xs opacity-80">
                            (親:{" "}
                            {player.statistic.ronPureScoreAvgWhenEast.toFixed(
                              2
                            )}
                            , 子:{" "}
                            {player.statistic.ronPureScoreAvgWhenNonEast.toFixed(
                              2
                            )}
                            )
                          </p>
                          <p className="text-xs opacity-80">
                            (立直後:{" "}
                            {player.statistic.ronAfterRiichiPureScoreAvg.toFixed(
                              2
                            )}
                            , 副露後:{" "}
                            {player.statistic.ronAfterRevealPureScoreAvg.toFixed(
                              2
                            )}
                            )
                          </p>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-xs opacity-80">
                            (親:{" "}
                            {player.statistic.chuckPureScoreAvgWhenEast.toFixed(
                              2
                            )}
                            , 子:{" "}
